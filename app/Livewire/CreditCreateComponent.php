...
class CreditCreateComponent extends Component
{
    public $open=false;
    public $customer;
    public $credit_line_id,$guarantee_id,$file_number,$tecnology_id,$policy_id,$time_limit_id,$interest_id,$initial_capital;
    ...
    public function render()
    {
        ...
        return view('livewire.credit-create-component',compact('tecnologies','funds','guarantees','creditlines','policies','timelimits','interests'));
    }
