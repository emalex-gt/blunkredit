...
class AmortizationPreviewComponent extends Component
{
    public $amortization,$interest,$timelimit;

    public $customer;
    public $credit_line_id,$guarantee_id,$file_number,$tecnology_id,$policy_id,$time_limit_id,$interest_id,$initial_capital,$total_payment;
    protected $listeners = ['infoRecibida'];

    public function infoRecibida($data)
    {
    ...
    {
        return view('livewire.amortization-preview-component');
    }
