                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div>
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Nuevo Crédito Retroactivo</h3>
                                    <div class="mt-2">
                                    ...
                                    <div class="border px-4 py-5">
                                        ...
                                        <div class="mt-2">
                                            <x-label value="Fecha de Expedición" />
                                            <x-input wire:model.live="expended_at" type="date" class="w-full" />
                                            <x-input-error for="expended_at" />
                                        </div>
                                        <div class="mt-2">
                                    ...
                                    <div>
                                        <x-danger-button wire:click="enviarInfoRetroactiva" class="mt-4 mb-4">
                                            Ver Tabla
                                        </x-danger-button>
                                        @livewire('amortization-retroactive-preview-component',[
                                                'customer' => $customer,
                                                'policy_id' => $policy_id
                                                ])
                                    </div>
