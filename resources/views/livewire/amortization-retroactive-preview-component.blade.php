        ...
        <div style="overflow:auto" id="tabla">
            <table class="w-full">
                <thead class="bg-gray-200">
                    <tr>
                        <th class="px-6 py-2 text-xs text-gray-500" colspan="6">Retroactivo: {{ $customer->code }} - {{ $customer->lastname }}, {{ $customer->name }}</th> 
                    </tr>
                    <tr>
                ...
                <tbody class="bg-white">
                    ...
                    @if($policy_id==1)        
                        @php
                            ...
                            $fecha=date('Y-m-d',strtotime($expended_at));
                        @endphp
