                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div>
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Crear Nuevo Interes</h3>
                                    <div class="mt-2">
                                        <x-label value="%" />
                                        <x-input wire:model.defer="name" type="text" placeholder="Ingrese el interés" class="w-full" />
